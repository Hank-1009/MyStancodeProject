...
-----------------------------
Milestone 4 answer:
epoch = 70 train error = 0.014631401238041642, validation error = 0.2613956105796285
epoch = 80 train error = 0.012380416432189083, validation error = 0.263083849184018
epoch = 90 train error = 0.009566685424873381, validation error = 0.2658975801913337
...
# TODO: 有的，training error 直接下降到0，然而validation error沒有什麼顯著的變化，甚至稍微提高，代表這個模型可能有overfitting的傾向
# TODO: train error = 0.0, validation error = 0.27687113111986494
############################################################
